...
public actual class BIDBanner public actual constructor(public val bidBannerSize: BIDAdFormat) : PlatformView(createBanner(
    BidappAds.getActivity(), bidBannerSize))
 {
